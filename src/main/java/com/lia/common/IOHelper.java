...
public class IOHelper {
   ...
   public static String readLine(String prompt) throws IOException, CancelInputException{
      String input = "";
      if (ide){
   ...
   public static int readStringChoose(Map<Integer, String> option) throws Exception{
      writeLine("--------------------------------------------------");
   ...
   public static int readObjectChoose(Map<Integer, CommonObject> option) throws Exception{
      writeLine("--------------------------------------------------");
      boolean choosed = false;
      String result = "";
      Integer index = -1;
